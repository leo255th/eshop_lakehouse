...
-- GRANT ALL         ON dwd_eshop_1m.* TO 'etl'@'%';
-- GRANT ALL         ON dws_eshop_1m.* TO 'etl'@'%';
-- GRANT ALL         ON ads_eshop_1m.* TO 'etl'@'%';
-- GRANT SELECT_PRIV ON paimon_eshop_1m.*.* TO 'etl'@'%';

ADMIN SET FRONTEND CONFIG ("dynamic_partition_check_interval_seconds" = "5");

CREATE DATABASE IF NOT EXISTS dwd_eshop_1m;
USE dwd_eshop_1m;
...
PROPERTIES (
  ...
  "colocate_with" = "grp_eshop_1m_product"
);
...
CREATE DATABASE IF NOT EXISTS dws_eshop_1m;
USE dws_eshop_1m;
...
CREATE DATABASE IF NOT EXISTS ads_eshop_1m;
USE ads_eshop_1m;
...
-- CREATE CATALOG paimon_eshop_1m PROPERTIES (
--   "type"             = "paimon",
