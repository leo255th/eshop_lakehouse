...
-- GRANT ALL         ON dwd_eshop_100m.* TO 'etl'@'%';
-- GRANT ALL         ON dws_eshop_100m.* TO 'etl'@'%';
-- GRANT ALL         ON ads_eshop_100m.* TO 'etl'@'%';
-- GRANT SELECT_PRIV ON paimon_eshop_100m.*.* TO 'etl'@'%';

ADMIN SET FRONTEND CONFIG ("dynamic_partition_check_interval_seconds" = "5");

CREATE DATABASE IF NOT EXISTS dwd_eshop_100m;
USE dwd_eshop_100m;
...
PROPERTIES (
  ...
  "colocate_with" = "grp_eshop_100m_product"
);
...
CREATE DATABASE IF NOT EXISTS dws_eshop_100m;
USE dws_eshop_100m;
...
CREATE DATABASE IF NOT EXISTS ads_eshop_100m;
USE ads_eshop_100m;
...
-- CREATE CATALOG paimon_eshop_100m PROPERTIES (
--   "type"             = "paimon",
...
SHOW DATABASES LIKE '%eshop_100m%';
