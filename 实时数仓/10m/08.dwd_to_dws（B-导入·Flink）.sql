...
CREATE TEMPORARY TABLE doris_dim_product (
  ...
  'table.identifier'       = 'dwd_eshop_10m.dim_product',
  'username'               = 'root',
  'password'               = 'doris@1998',
  'sink.label-prefix'      = 'eshop_10m_doris_dim_product',
...
CREATE TEMPORARY TABLE doris_dim_user (
  ...
  'connector'              = 'doris',
  'fenodes'                = 'hadoop101:8030',
  'table.identifier'       = 'dwd_eshop_10m.dim_user',
  'username'               = 'root',
  'password'               = 'doris@1998',
  'sink.label-prefix'      = 'eshop_10m_doris_dim_user',
  'sink.properties.format' = 'json',
  'sink.properties.read_json_by_line' = 'true',
  'sink.enable-delete'     = 'true',
  'sink.parallelism'       = '1'
...
CREATE TEMPORARY TABLE doris_fact_order_item (
  ...
  'connector'              = 'doris',
  'fenodes'                = 'hadoop101:8030',
  'table.identifier'       = 'dwd_eshop_10m.fact_order_item',
  'username'               = 'root',
  'password'               = 'doris@1998',
  'sink.label-prefix'      = 'eshop_10m_doris_fact_order_item',
  'sink.properties.format' = 'json',
  'sink.properties.read_json_by_line' = 'true',
  'sink.enable-delete'     = 'true',
  'sink.parallelism'       = '2'
...
CREATE TEMPORARY TABLE doris_fact_order_acc (
  ...
  'connector'              = 'doris',
  'fenodes'                = 'hadoop101:8030',
  'table.identifier'       = 'dwd_eshop_10m.fact_order_acc',
  'username'               = 'root',
  'password'               = 'doris@1998',
  'sink.label-prefix'      = 'eshop_10m_doris_fact_order_acc',
  'sink.properties.format' = 'json',
  'sink.properties.read_json_by_line' = 'true',
  'sink.enable-delete'     = 'true',
  'sink.parallelism'       = '2'
...
CREATE TEMPORARY TABLE doris_dws_trade_user_day (
  ...
  'connector'              = 'doris',
  'fenodes'                = 'hadoop101:8030',
  'table.identifier'       = 'dws_eshop_10m.dws_trade_user_day',
  'username'               = 'root',
  'password'               = 'doris@1998',
  'sink.label-prefix'      = 'eshop_10m_doris_dws_trade_user_day',
  'sink.properties.format' = 'json',
  'sink.properties.read_json_by_line' = 'true',
  'sink.enable-delete'     = 'true',
  'sink.parallelism'       = '2'
...
--     SELECT COUNT(*) FROM dwd_eshop_10m.fact_order_item;
